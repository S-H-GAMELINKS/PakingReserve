...
class ReservesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserf" do
    assert_difference('Reserve.count') do
      post reserves_url, params: { reserf: { address: @reserf.address, name: @reserf.name, price: @reserf.price, reserved: @reserf.reserved, tel: @reserf.tel } }
    end
  ...
  test "should update reserf" do
    patch reserf_url(@reserf), params: { reserf: { address: @reserf.address, name: @reserf.name, price: @reserf.price, reserved: @reserf.reserved, tel: @reserf.tel } }
